...
for i in range(0,296):
	now_slice=(ToTensor(Image.open('/fdisk/22/modset2/%05d'%i+'_mask.png'))[0])
	...
	ds.__setattr__("Rows", 80)    # 设置新矩阵的row，row是newimg的row
	ds.__setattr__("Columns", 80)    # 设置新矩阵的column，col是newimg的col
	...
	dcm_path="./bw3/ser017img%05d.dcm"%i
	ds.save_as(dcm_path)
